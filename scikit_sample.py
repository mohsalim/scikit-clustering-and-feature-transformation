...
# First data set is tic tac toe, second data set is nursery school rankings applications.
run_first_data_set = True

if run_first_data_set:
    ...
    # Get data from arff file.
    dataset = arff.load(open('nursery-split.arff', 'r'))
    data = np.array(dataset['data'])
    # 27 features after splitting data. It's a coincidence that it matche the other datasets feature count...
    feature_count = 27

    # Anaylized part 1 data and these were peak points for a lot of the metrics.
    k_list = [1, 2, 3, 7, 8, 5, 15, 17, 20, 23, 27]
